...
return array(
	...
	'license_title' => 'ข้อตกลง hhj luntan 4.0',
...
hhj luntan 4.0 ใช้งาน Bootstrap 4 + jQuery 3 เป็นไลบราลีระบบหน้าบ้าน รองรับเบราว์เซอร์มือถือเต็มรูปแบบ และระบบหลังบ้านมีการใช้งาน XiunoPHP 4.0 รองรับ NoSQL เป็นช่องทางการทำงานกับฐานข้อมูลที่หลากหลาย เวอร์ชันนี้เป็นก้าวใหญ่ที่สำคัญของเรา
...
hhj luntan 4 ใช้งานข้อตกลง MIT คุณสามารถแก้ไขได้อย่างอิสระ เปลี่ยนแปลงเวอร์ชัน หรือใช้งานในเชิงพาณิชย์ได้โดยไม่ต้องกังวลในทางกฎหมายใด ๆ (ควรเก็บข้อมูลลิขสิทธิ์เดิมไว้)
	',
	'license_date' => 'วันที่ปล่อย: 22 มกราคม 2018',
	'agree_license_to_continue' => 'ยอมรับข้อตกลงและดำเนินการติดตั้งต่อ',
	'install_title' => 'ตัวช่วยติดตั้ง hhj luntan 4.0',
