...
if(!defined('SKIP_ROUTE')) {
	...
	switch ($route) {
		...
		case 'qq_login':		include _include(APP_PATH.'plugin/iqismart_qqlogin/route/qq_login.php'); 	break;case 'mip': include _include(APP_PATH.'plugin/tt_seo/mip.php'); break;case 'wx_login': include APP_PATH.'plugin/zz_iqismart_weixin/route/wx_login.php'; break;
